...
ideal_supplier_parameters = {
    ...
    'Выручка': '459.9 млрд ₽',
    'Прибыль': '114.9 млрд ₽',
    'Истец': {'Выиграл': '81%', 'Проиграл': '3%', 'Прочие': '16%'},
    'Ответчик': {'Выиграл': '3%', 'Проиграл': '80%', 'Прочие': '17%'},
    'Уставный капитал': '8.4 млн ₽',
    'Стоимость': '2153.1 млрд ₽',
    'Тендер': {'Участник': '607', 'Выиграл': '304'},
    'Госконтракты': '393',
    'Надежность': {'Плюсы': '+ 97', 'Минусы': '- 7.2'}
}
